    ...
    def run(self):
        ...
        try:
            while self.corriendo:
                ByteA = self.sensor.readU16(self.ADDRESS_OBJECT)
                temperatura = ByteA/50-273.15
...
if __name__ == '__main__':
    ...
    while True:
        sleep(10)
        print('La temperatura en este momento es {}'.format(temperaturaorgano.temperturaOrgano))
